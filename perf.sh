...
date; valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes cargo +stable test --release -- --nocapture || exit $?
date; valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes cargo +stable test -- --nocapture || exit $?
date; valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes cargo +stable bench -- --nocapture || exit $?
